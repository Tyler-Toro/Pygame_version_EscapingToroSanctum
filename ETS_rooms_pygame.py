...
entire team to move aside. Shards of glass fall off of repositioned boxes. Something catches {ETS_user.user_name}\'s eye. ", (5, 10))
    pause()
    text_slowmo("Among the glass are pieces of shredded flesh and clumps of hair ", (5, 100), fill = False, speed = .07)
    text_slowmo(".. ........ .... ............. .. ", (5, 130), fill = False, sleep = step)
    text_slowmo(f"({ETS_user.user_name}): \"...... WAIT .... ALPHA TEAM FALL BAC------ ", (15, 160), speed = .07)
    zombie_battle(ETS_user)
